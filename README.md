...
- GitHub Pages está activo en `https://javiig13.github.io/SierraNueva/`. El
  despliegue manual real terminó correctamente con catorce promociones de
  catorce fuentes, cero fallos y sin publicar `data/state`; la vista activa
  muestra once opciones y también se comprobó una URL directa con filtro
  (`?q=Galapagar`).
